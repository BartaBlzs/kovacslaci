...
@section('title', 'Város Szerkesztése')
...
<form action="{{ route('cities.update', $city) }}" method="POST">
    ...
    <input type="text" name="postal_codes" id="postal_codes" required 
           value="{{ old('postal_codes', $city->postalCodes->pluck('code')->implode(', ')) }}" 
           placeholder="pl: 1011, 1012, 1013">
